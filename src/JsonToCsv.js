    ...
    <div id="csv">
      ...
      <div className="row mx-5">
        <div className="col-12">
          <h5>Add your Json to convert</h5>
          <textarea 
      ...
      <div className="row d-flex flex-row mx-5 mt-3">
        <div className="col-12">
          <button type="button" className="btn btn-success mt-1 mx-1" onClick={()=>buscar(info)}>Convert</button>
          <button type="button" className="btn btn-primary mt-1 mx-1" onClick={formatearJson}>Give format to your JSON</button>
          <button type="button" className="btn btn-primary mt-1 mx-1" onClick={reset}>Clean inputs</button>
        </div>
        <div className="col-12 d-flex flex-row mt-3">
          <h5 className="mt-3 me-3">Examples:</h5>
